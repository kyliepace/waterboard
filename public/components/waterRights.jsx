...
var WaterRights = React.createClass({
	...
	render: function(props){
		...
		var answer = that.props.waterRights.answers[index]; //should be an array
		...
		if(index>=100 && index<1000){
			...
			var show = (
				<Question onSubmit={that.onSubmit} onClick={that.prevQuestion} user={that.props.waterRights}
